            ...
            <div className="container bg-white py-16 sm:py-16">
                ...
                <div className="w-5/6 mx-auto">
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 lg:mx-0 lg:max-w-none lg:grid-cols-2 text-gray-700">
                        <div className="flex max-w-xl flex-col items-start justify-center p-4">
                        ...
                        <div className="flex max-w-xl flex-col items-center justify-between p-4 ">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3275.546268481749!2d-82.44306612453853!3d34.817355472878525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8858308faec0ae91%3A0x6958e29fe7a3f400!2s2600%20Anderson%20Rd%2C%20Greenville%2C%20SC%2029611%2C%20USA!5e0!3m2!1sen!2sin!4v1682661759060!5m2!1sen!2sin" width="600" height="300" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
