            ...
            <div className="container bg-white py-16 sm:py-16">
                ...
                <div className="w-5/6 mx-auto my-12 text-gray-900">
                    <div className="flex gap-3 items-center">
                        <div className={`w-auto text-center p-3 border rounded-full drop-shadow cursor-pointer ${after === 0 && 'cursor-not-allowed'}`}>
                        ...
                        <div className="w-full flex gap-4">
                            ...
                            {Object.values(TestimonialsData).slice(after, after + 3).map((key) => (
                                <div className="border border-gray-200 rounded drop-shadow p-4 w-4/12 text-center" key={key.Name}>
                                    ...
                                    <div className="flex justify-between items-center mt-3"><Rating /><span>{key.Date}</span></div>
                                </div>
                            ))}
                        </div>
                        <div className={`w-auto text-center p-3 border rounded-full drop-shadow cursor-pointer ${(after + 3 > TestimonialsData.length - 1) && 'cursor-not-allowed'}`}>
